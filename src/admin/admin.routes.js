...
router.get('/subscription/quick-action', async (req, res) => {
  ...
  try {
    ...
    if (action === 'approve') {
      ...
      // Note: email chiffré - notification envoyée à l'admin uniquement
      console.log(`[admin] Abonnement activé pour ${user?.pseudo}`);
      ...
      console.log(`[admin] Demande rejetée pour ${user?.pseudo}`);
